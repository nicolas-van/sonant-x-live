...
},{}],"presets.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/sonantx/dist/sonantx.bundle.js":[function(require,module,exports) {
var define;
!function(t,e){"object"==typeof exports&&"object"==typeof module?module.exports=e():"function"==typeof define&&define.amd?define([],e):"object"==typeof exports?exports.sonantx=e():t.sonantx=e()}(window,function(){return function(t){var e={};function n(o){if(e[o])return e[o].exports;var i=e[o]={i:o,l:!1,exports:{}};return t[o].call(i.exports,i,i.exports,n),i.l=!0,i.exports}return n.m=t,n.c=e,n.d=function(t,e,o){n.o(t,e)||Object.defineProperty(t,e,{enumerable:!0,get:o})},n.r=function(t){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(t,"__esModule",{value:!0})},n.t=function(t,e){if(1&e&&(t=n(t)),8&e)return t;if(4&e&&"object"==typeof t&&t&&t.__esModule)return t;var o=Object.create(null);if(n.r(o),Object.defineProperty(o,"default",{enumerable:!0,value:t}),2&e&&"string"!=typeof t)for(var i in t)n.d(o,i,function(e){return t[e]}.bind(null,i));return o},n.n=function(t){var e=t&&t.__esModule?function(){return t.default}:function(){return t};return n.d(e,"a",e),e},n.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)},n.p="",n(n.s=0)}([function(t,e,n){"use strict";n.r(e),n.d(e,"AudioGenerator",function(){return h}),n.d(e,"SoundGenerator",function(){return d}),n.d(e,"MusicGenerator",function(){return v});var o=2,i=33,r=null;function s(t){return Math.sin(6.283184*t)}var a=[s,function(t){return s(t)<0?-1:1},function(t){return t%1-.5},function(t){var e=t%1*4;return e<2?e-1:3-e}];function u(t){return.00390625*Math.pow(1.059463094,t-128)}function f(t,e){setTimeout(function(){var n=new Uint8Array(t*o*2),r=n.length-2,s=function(){for(var t=new Date,o=0;r>=0;)if(n[r]=0,n[r+1]=128,r-=2,(o+=1)%1e3==0&&new Date-t>i)return void setTimeout(s,0);setTimeout(function(){e(n)},0)};setTimeout(s,0)},0)}function c(t,e,n,o,r){var s=n.fx_delay_time*o>>1,a=n.fx_delay_amt/255,u=0,f=function(){for(var n=new Date,o=0;u<e-s;){var c=4*u,h=4*(u+s),d=t[h]+(t[h+1]<<8)+(t[c+2]+(t[c+3]<<8)-32768)*a;if(t[h]=255&d,t[h+1]=d>>8&255,d=t[h+2]+(t[h+3]<<8)+(t[c]+(t[c+1]<<8)-32768)*a,t[h+2]=255&d,t[h+3]=d>>8&255,++u,(o+=1)%1e3==0&&new Date-n>i)return void setTimeout(f,0)}setTimeout(r,0)};setTimeout(f,0)}var h=function(t){this.mixBuf=t,this.waveSize=t.length/o/2};h.prototype.getWave=function(){var t,e,n,i,r,s,a,u=this.mixBuf,f=this.waveSize*o*2;for(s=(r=f-8)-36,i=String.fromCharCode(82,73,70,70,255&r,r>>8&255,r>>16&255,r>>24&255,87,65,86,69,102,109,116,32,16,0,0,0,1,0,2,0,68,172,0,0,16,177,2,0,4,0,16,0,100,97,116,97,255&s,s>>8&255,s>>16&255,s>>24&255),t=0;t<f;){for(n="",e=0;e<256&&t<f;++e,t+=2)a=(a=4*(u[t]+(u[t+1]<<8)-32768))<-32768?-32768:a>32767?32767:a,n+=String.fromCharCode(255&a,a>>8&255);i+=n}return i},h.prototype.getAudio=function(){var t=this.getWave(),e=new Audio("data:audio/wav;base64,"+btoa(t));return e.preload="none",e.load(),e},h.prototype.getAudioBuffer=function(t){null===r&&(r=new AudioContext);var e=this.mixBuf,n=this.waveSize,s=r.createBuffer(o,this.waveSize,44100),a=s.getChannelData(0),u=s.getChannelData(1),f=0,c=function(){for(var o=new Date,r=0;f<n;){var h=4*(e[4*f]+(e[4*f+1]<<8)-32768);if(h=h<-32768?-32768:h>32767?32767:h,a[f]=h/32768,h=(h=4*(e[4*f+2]+(e[4*f+3]<<8)-32768))<-32768?-32768:h>32767?32767:h,u[f]=h/32768,f+=1,(r+=1)%1e3==0&&new Date-o>i)return void setTimeout(c,0)}setTimeout(function(){t(s)},0)};setTimeout(c,0)};var d=function(t,e){this.instr=t,this.rowLen=e||5605,this.osc_lfo=a[t.lfo_waveform],this.osc1=a[t.osc1_waveform],this.osc2=a[t.osc2_waveform],this.attack=t.env_attack,this.sustain=t.env_sustain,this.release=t.env_release,this.panFreq=Math.pow(2,t.fx_pan_freq-8)/this.rowLen,this.lfoFreq=Math.pow(2,t.lfo_freq-8)/this.rowLen};d.prototype.genSound=function(t,e,n){new Date;for(var o=0,i=0,r=u(t+12*(this.instr.osc1_oct-8)+this.instr.osc1_det)*(1+8e-4*this.instr.osc1_detune),a=u(t+12*(this.instr.osc2_oct-8)+this.instr.osc2_det)*(1+8e-4*this.instr.osc2_detune),f=this.instr.fx_resonance/255,c=0,h=0,d=this.attack+this.sustain+this.release-1;d>=0;--d){var v=d+n,l=this.osc_lfo(v*this.lfoFreq)*this.instr.lfo_amt/512+.5,p=1;d<this.attack?p=d/this.attack:d>=this.attack+this.sustain&&(p-=(d-this.attack-this.sustain)/this.release);var _=r;this.instr.lfo_osc1_freq&&(_+=l),this.instr.osc1_xenv&&(_*=p*p),o+=_;var w=this.osc1(o)*this.instr.osc1_vol;_=a,this.instr.osc2_xenv&&(_*=p*p),i+=_,w+=this.osc2(i)*this.instr.osc2_vol,this.instr.noise_fader&&(w+=(2*Math.random()-1)*this.instr.noise_fader*p),w*=p/255;var g=this.instr.fx_freq;this.instr.lfo_fx_freq&&(g*=l);var m=f*(w-h)-(c+=(g=1.5*Math.sin(3.141592*g/44100))*h);switch(h+=g*m,this.instr.fx_filter){case 1:w=m;break;case 2:w=c;break;case 3:w=h;break;case 4:w=c+m}if(_=s(v*this.panFreq)*this.instr.fx_pan_amt/512+.5,w*=39*this.instr.env_master,(v*=4)+3<e.length){var y=e[v]+(e[v+1]<<8)+w*(1-_);e[v]=255&y,e[v+1]=y>>8&255,y=e[v+2]+(e[v+3]<<8)+w*_,e[v+2]=255&y,e[v+3]=y>>8&255}}},d.prototype.getAudioGenerator=function(t,e){var n=this.attack+this.sustain+this.release-1+32*this.rowLen,o=this;f(n,function(i){o.genSound(t,i,0),c(i,n,o.instr,o.rowLen,function(){e(new h(i))})})},d.prototype.createAudio=function(t,e){this.getAudioGenerator(t,function(t){e(t.getAudio())})},d.prototype.createAudioBuffer=function(t,e){this.getAudioGenerator(t,function(t){t.getAudioBuffer(e)})};var v=function(t){this.song=t,this.waveSize=44100*t.songLen};v.prototype.generateTrack=function(t,e,n){var r=this;f(this.waveSize,function(s){var a=r.waveSize,u=r.waveSize*o*2,f=r.song.rowLen,h=r.song.endPattern,v=new d(t,f),l=0,p=0,_=0,w=function(){for(var e=new Date;;)if(32!==_){if(p===h-1)return void setTimeout(g,0);var n=t.p[p];if(n){var o=t.c[n-1].n[_];o&&v.genSound(o,s,l)}if(l+=f,_+=1,new Date-e>i)return void setTimeout(w,0)}else _=0,p+=1},g=function(){c(s,a,t,f,y)},m=0,y=function(){for(var t=new Date,o=0;m<u;){var r=e[m]+(e[m+1]<<8)+s[m]+(s[m+1]<<8)-32768;if(e[m]=255&r,e[m+1]=r>>8&255,m+=2,(o+=1)%1e3==0&&new Date-t>i)return void setTimeout(y,0)}setTimeout(n,0)};setTimeout(w,0)})},v.prototype.getAudioGenerator=function(t){var e=this;f(this.waveSize,function(n){var o=0,i=function(){o<e.song.songData.length?(o+=1,e.generateTrack(e.song.songData[o-1],n,i)):t(new h(n))};i()})},v.prototype.createAudio=function(t){this.getAudioGenerator(function(e){t(e.getAudio())})},v.prototype.createAudioBuffer=function(t){this.getAudioGenerator(function(e){e.getAudioBuffer(t)})}}])});
...
},{}],"node_modules/urijs/src/punycode.js":[function(require,module,exports) {
var global = arguments[3];
var define;
...
},{"./punycode":"node_modules/urijs/src/punycode.js","./IPv6":"node_modules/urijs/src/IPv6.js","./SecondLevelDomains":"node_modules/urijs/src/SecondLevelDomains.js"}],"node_modules/underscore/underscore.js":[function(require,module,exports) {
var global = arguments[3];
var define;
//     Underscore.js 1.9.1
...
},{}],"gui/wave-sin-sel.png":[function(require,module,exports) {
module.exports = "/wave-sin-sel.3ad03333.png";
},{}],"gui/wave-sqr-sel.png":[function(require,module,exports) {
module.exports = "/wave-sqr-sel.5a39875c.png";
},{}],"gui/wave-saw-sel.png":[function(require,module,exports) {
module.exports = "/wave-saw-sel.99682830.png";
},{}],"gui/wave-tri-sel.png":[function(require,module,exports) {
module.exports = "/wave-tri-sel.ae0e60bc.png";
},{}],"gui/wave-sin.png":[function(require,module,exports) {
module.exports = "/wave-sin.d1b9df94.png";
},{}],"gui/wave-sqr.png":[function(require,module,exports) {
module.exports = "/wave-sqr.600170ce.png";
},{}],"gui/wave-saw.png":[function(require,module,exports) {
module.exports = "/wave-saw.deb969ae.png";
},{}],"gui/wave-tri.png":[function(require,module,exports) {
module.exports = "/wave-tri.e747ef99.png";
},{}],"gui/box-check.png":[function(require,module,exports) {
module.exports = "/box-check.cf0d8c54.png";
},{}],"gui/box-uncheck.png":[function(require,module,exports) {
module.exports = "/box-uncheck.ca00a966.png";
},{}],"gui/progress.gif":[function(require,module,exports) {
module.exports = "/progress.703a7497.gif";
},{}],"gui/filt-lp.png":[function(require,module,exports) {
module.exports = "/filt-lp.d4fa1230.png";
},{}],"gui/filt-lp-sel.png":[function(require,module,exports) {
module.exports = "/filt-lp-sel.bf1d014b.png";
},{}],"gui/filt-hp.png":[function(require,module,exports) {
module.exports = "/filt-hp.a879202d.png";
},{}],"gui/filt-hp-sel.png":[function(require,module,exports) {
module.exports = "/filt-hp-sel.c3ad4d25.png";
},{}],"gui/filt-bp.png":[function(require,module,exports) {
module.exports = "/filt-bp.abe69b18.png";
},{}],"gui/filt-bp-sel.png":[function(require,module,exports) {
module.exports = "/filt-bp-sel.732394f4.png";
},{}],"gui/filt-n.png":[function(require,module,exports) {
module.exports = "/filt-n.ff0aff1b.png";
},{}],"gui/filt-n-sel.png":[function(require,module,exports) {
module.exports = "/filt-n-sel.04b57a4a.png";
},{}],"gui/playGfxBg.png":[function(require,module,exports) {
module.exports = "/playGfxBg.cba0e693.png";
},{}],"gui/led-off.png":[function(require,module,exports) {
module.exports = "/led-off.812fc5bb.png";
},{}],"gui/led-on.png":[function(require,module,exports) {
module.exports = "/led-on.047c7ad7.png";
...
exports.gui_init = void 0;

var _jquery = _interopRequireDefault(require("jquery"));

var _presets = _interopRequireDefault(require("./presets"));

var sonantx = _interopRequireWildcard(require("sonantx"));
...
var _waveSinSel = _interopRequireDefault(require("./gui/wave-sin-sel.png"));

var _waveSqrSel = _interopRequireDefault(require("./gui/wave-sqr-sel.png"));

var _waveSawSel = _interopRequireDefault(require("./gui/wave-saw-sel.png"));

var _waveTriSel = _interopRequireDefault(require("./gui/wave-tri-sel.png"));

var _waveSin = _interopRequireDefault(require("./gui/wave-sin.png"));

var _waveSqr = _interopRequireDefault(require("./gui/wave-sqr.png"));

var _waveSaw = _interopRequireDefault(require("./gui/wave-saw.png"));

var _waveTri = _interopRequireDefault(require("./gui/wave-tri.png"));

var _boxCheck = _interopRequireDefault(require("./gui/box-check.png"));

var _boxUncheck = _interopRequireDefault(require("./gui/box-uncheck.png"));

var _progress = _interopRequireDefault(require("./gui/progress.gif"));

var _filtLp = _interopRequireDefault(require("./gui/filt-lp.png"));

var _filtLpSel = _interopRequireDefault(require("./gui/filt-lp-sel.png"));

var _filtHp = _interopRequireDefault(require("./gui/filt-hp.png"));

var _filtHpSel = _interopRequireDefault(require("./gui/filt-hp-sel.png"));

var _filtBp = _interopRequireDefault(require("./gui/filt-bp.png"));

var _filtBpSel = _interopRequireDefault(require("./gui/filt-bp-sel.png"));

var _filtN = _interopRequireDefault(require("./gui/filt-n.png"));

var _filtNSel = _interopRequireDefault(require("./gui/filt-n-sel.png"));

var _playGfxBg = _interopRequireDefault(require("./gui/playGfxBg.png"));

var _ledOff = _interopRequireDefault(require("./gui/led-off.png"));

var _ledOn = _interopRequireDefault(require("./gui/led-on.png"));
...
var CGUI = function CGUI() {
  ...
  var mPlayGfxLedOnImg = new Image(); // Constant look-up-tables
  ...
  var calcSamplesPerRow = function calcSamplesPerRow(bpm) {
  ...
  var makeNewSong = function makeNewSong() {
    var song = {}; // Row length

    song.rowLen = calcSamplesPerRow(120); // Last pattern to play
  ...
  var convertSong = function convertSong(song) {
    ...
    for (i = 0; i < 8; i++) {
      ...
      if (instr === undefined) {
        ...
        instr.osc1_xenv = 0;
        instr.osc1_vol = 192;
        instr.osc1_waveform = 0; // Oscillator 2
        ...
        instr.osc2_xenv = 0;
        instr.osc2_vol = 192;
        instr.osc2_waveform = 0; // Noise oscillator

        instr.noise_fader = 0; // Envelope

        instr.env_attack = 200;
        instr.env_sustain = 2000;
        instr.env_release = 20000;
        instr.env_master = 192; // Effects
  ...
  var compressSong = function compressSong(song) {
    song = _underscore.default.clone(song);
    song.songData = _underscore.default.map(song.songData, function (d) {
      d = _underscore.default.clone(d);
      var lastNotZero = -1;
      var used = [];
      ...
      d.p = d.p.slice(0, lastNotZero + 1); // remove unused patterns

      var lastPattern = _underscore.default.max(used);

      d.c = d.c.slice(0, lastPattern);
      return d;
    });
    song.songData = _underscore.default.filter(song.songData, function (d) {
      return d.p.length > 0;
    });
    return song;
  };
  ...
  var getMousePos = function getMousePos(e, rel) {
    ...
    if (e.pageX || e.pageY) {
      ...
      p = [e.clientX + document.body.scrollLeft + document.documentElement.scrollLeft, e.clientY + document.body.scrollTop + document.documentElement.scrollTop];
    }

    if (!rel) return p; // Get the element document position
  ...
  var updateSequencer = function updateSequencer(scrollIntoView, selectionOnly) {
    var o; // Update sequencer element contents and selection
  ...
  var setSelectedPatternRow = function setSelectedPatternRow(row) {
    mPatternRow = row;
    mPatternRow2 = row;
  ...
  var setSelectedPatternRow2 = function setSelectedPatternRow2(row) {
  ...
  var setSelectedSequencerCell = function setSelectedSequencerCell(col, row) {
    mSeqCol = col;
    mSeqRow = row;
    mSeqCol2 = col;
    mSeqRow2 = row;
  ...
  var setSelectedSequencerCell2 = function setSelectedSequencerCell2(col, row) {
  ...
  var addPatternNote = function addPatternNote(n) {
    ...
    if (mEditMode === EDIT_PATTERN && mSeqCol === mSeqCol2 && mSeqRow === mSeqRow2 && mPatternRow === mPatternRow2) {
  ...
  var updateSlider = function updateSlider(o, x) {
  ...
  var updateCheckBox = function updateCheckBox(o, check) {
    o.src = check ? _boxCheck.default : _boxUncheck.default;
  };
  ...
  var updateSongRanges = function updateSongRanges() {
    var i, j, emptyRow; // Determine the last song pattern
  ...
  var newSong = function newSong(song) {
    ...
    updateSequencer();
    updatePattern();
    updateInstrument(); // Initialize the song
  ...
  var openSong = function openSong(e) {
    showOpenDialog();
    return false;
  };
  ...
  var exportJSON = function exportJSON(e) {
    // Update song ranges
  ...
  var exportInstrument = function exportInstrument() {
    if (mSeqCol !== mSeqCol2 || mSeqCol < 0 || mSeqCol >= mSong.songData.length) {
      return;
    }

    var instr = _underscore.default.clone(mSong.songData[mSeqCol]);
  ...
  var exportURL = function exportURL(e) {
    // Update song ranges
    updateSongRanges();
  ...
  var generateAudio = function generateAudio(doneFun, opts) {
    ...
    var oSong = _underscore.default.clone(mSong);

    if (opts) {
      oSong.songData = mSong.songData.slice(opts.firstCol, opts.lastCol + 1);
      oSong.songData = _underscore.default.map(oSong.songData, function (data) {
        var ndata = _underscore.default.clone(data);
  ...
  var getSamplesSinceNote = function getSamplesSinceNote(t, chan) {
    ...
    if (ctx) {
      ...
      if (mFollowerActive && t >= 0) {
        ...
        for (i = 1; i < wave.length; i += 2) {
          l = wave[i - 1];
          r = wave[i]; // Band-pass filter (low-pass + high-pass)

          sl = 0.8 * l + 0.1 * sl - 0.3 * l_old;
          sr = 0.8 * r + 0.1 * sr - 0.3 * r_old;
          l_old = l;
          r_old = r; // Sum of squares
  ...
  var updateFollower = function updateFollower() {
    var i, o;
    if (mAudio === null) return; // Calculate current song position

    var t = mAudio.currentTime;
    var n = Math.floor(t * 44100 / mSong.rowLen);
    var seqPos = Math.floor(n / 32) + mFollowerFirstRow;
    var patPos = n % 32; // Are we past the play range (i.e. stop the follower?)

    if (seqPos > mFollowerLastRow) {
      stopFollower(); // Reset pattern position
    ...
    var newPatPos = newSeqPos || patPos !== mPatternRow; // Update the sequencer
  ...
  var playSong = function playSong(e) {
    ...
    stopPlaying(); // Update song ranges
    ...
    mFollowerFirstCol = 0;
    mFollowerLastCol = 7; // Generate audio data
  ...
  var playRange = function playRange(e) {
    // Stop the currently playing audio
    stopPlaying(); // Update song ranges
    ...
    mFollowerLastCol = mSeqCol2; // Generate audio data
  ...
  var bpmFocus = function bpmFocus(e) {
    setEditMode(EDIT_NONE);
    return true;
  };

  var instrPresetFocus = function instrPresetFocus(e) {
    setEditMode(EDIT_NONE);
    return true;
  };

  var patternCopyMouseDown = function patternCopyMouseDown(e) {
  ...
  var patternPasteMouseDown = function patternPasteMouseDown(e) {
    if (mSeqRow === mSeqRow2 && mSeqCol === mSeqCol2) {
      var pat = mSong.songData[mSeqCol].p[mSeqRow] - 1;
  ...
  var patternNoteUpMouseDown = function patternNoteUpMouseDown(e) {
    if (mSeqRow === mSeqRow2 && mSeqCol === mSeqCol2) {
      var pat = mSong.songData[mSeqCol].p[mSeqRow] - 1;
  ...
  var patternNoteDownMouseDown = function patternNoteDownMouseDown(e) {
    if (mSeqRow === mSeqRow2 && mSeqCol === mSeqCol2) {
      var pat = mSong.songData[mSeqCol].p[mSeqRow] - 1;
  ...
  var patternOctaveUpMouseDown = function patternOctaveUpMouseDown(e) {
    if (mSeqRow === mSeqRow2 && mSeqCol === mSeqCol2) {
      var pat = mSong.songData[mSeqCol].p[mSeqRow] - 1;
  ...
  var patternOctaveDownMouseDown = function patternOctaveDownMouseDown(e) {
    if (mSeqRow === mSeqRow2 && mSeqCol === mSeqCol2) {
      var pat = mSong.songData[mSeqCol].p[mSeqRow] - 1;
  ...
  var sequencerCopyMouseDown = function sequencerCopyMouseDown(e) {
    mSeqCopyBuffer = [];
  ...
  var sequencerPasteMouseDown = function sequencerPasteMouseDown(e) {
  ...
  var sequencerPatUpMouseDown = function sequencerPatUpMouseDown(e) {
    for (var row = mSeqRow; row <= mSeqRow2; ++row) {
      for (var col = mSeqCol; col <= mSeqCol2; ++col) {
  ...
  var sequencerPatDownMouseDown = function sequencerPatDownMouseDown(e) {
    for (var row = mSeqRow; row <= mSeqRow2; ++row) {
      for (var col = mSeqCol; col <= mSeqCol2; ++col) {
        var pat = mSong.songData[col].p[row];
  ...
  var applyInstrument = function applyInstrument(src, to) {
  ...
  var keyboardMouseDown = function keyboardMouseDown(e) {
    ...
    if (p[1] < 67) {
      ...
      for (var i = 0; i < mBlackKeyPos.length; i += 2) {
        if (p[0] >= mBlackKeyPos[i] - 5 && p[0] <= mBlackKeyPos[i] + 5) {
          n = mBlackKeyPos[i + 1];
          break;
        }
      }
  ...
  var mouseMove = function mouseMove(e) {
    ...
    if (mActiveSlider) {
      ...
      x = x < 0 ? 0 : x > 191 ? 1 : x / 191; // Adapt to the range of the slider
  ...
  var activateMasterEvents = function activateMasterEvents() {
    // Set up the master mouse event handlers
    document.onmousedown = null;
    document.onmousemove = mouseMove;
    document.onmouseup = mouseUp; // Set up the master key event handler

    document.onkeydown = keyDown;
  };

  var deactivateMasterEvents = function deactivateMasterEvents() {
    // Set up the master mouse event handlers
  ...
  this.init = function () {
    var i, j, o; // Preload images

    preloadImage(_progress.default);
    preloadImage(_boxUncheck.default);
    preloadImage(_boxUncheck.default);
    preloadImage(_waveSin.default);
    preloadImage(_waveSinSel.default);
    preloadImage(_waveSaw.default);
    preloadImage(_waveSawSel.default);
    preloadImage(_waveSqr.default);
    preloadImage(_waveSqrSel.default);
    preloadImage(_waveTri.default);
    preloadImage(_waveTriSel.default);
    preloadImage(_filtLp.default);
    preloadImage(_filtLpSel.default);
    preloadImage(_filtHp.default);
    preloadImage(_filtHpSel.default);
    preloadImage(_filtBp.default);
    preloadImage(_filtBpSel.default);
    preloadImage(_filtN.default);
    preloadImage(_filtNSel.default); // Set up presets

    initPresets(); // Load images for the play graphics canvas
    ...
    mPlayGfxVUImg.src = _playGfxBg.default;
...
},{"jquery":"node_modules/jquery/dist/jquery.js","./presets":"presets.js","sonantx":"node_modules/sonantx/dist/sonantx.bundle.js","lz-string":"node_modules/lz-string/libs/lz-string.js","urijs":"node_modules/urijs/src/URI.js","underscore":"node_modules/underscore/underscore.js","./gui/wave-sin-sel.png":"gui/wave-sin-sel.png","./gui/wave-sqr-sel.png":"gui/wave-sqr-sel.png","./gui/wave-saw-sel.png":"gui/wave-saw-sel.png","./gui/wave-tri-sel.png":"gui/wave-tri-sel.png","./gui/wave-sin.png":"gui/wave-sin.png","./gui/wave-sqr.png":"gui/wave-sqr.png","./gui/wave-saw.png":"gui/wave-saw.png","./gui/wave-tri.png":"gui/wave-tri.png","./gui/box-check.png":"gui/box-check.png","./gui/box-uncheck.png":"gui/box-uncheck.png","./gui/progress.gif":"gui/progress.gif","./gui/filt-lp.png":"gui/filt-lp.png","./gui/filt-lp-sel.png":"gui/filt-lp-sel.png","./gui/filt-hp.png":"gui/filt-hp.png","./gui/filt-hp-sel.png":"gui/filt-hp-sel.png","./gui/filt-bp.png":"gui/filt-bp.png","./gui/filt-bp-sel.png":"gui/filt-bp-sel.png","./gui/filt-n.png":"gui/filt-n.png","./gui/filt-n-sel.png":"gui/filt-n-sel.png","./gui/playGfxBg.png":"gui/playGfxBg.png","./gui/led-off.png":"gui/led-off.png","./gui/led-on.png":"gui/led-on.png"}],"index.js":[function(require,module,exports) {
"use strict";
...
gui.gui_init();
},{"./gui":"gui.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/sonant-x-live.e31bb0bc.js.map